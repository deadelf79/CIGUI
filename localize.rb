...
module CIGUI
	class << self
		...
		def localize_ru
			...
			VOCAB[:window][:labeled]    = @original_VOCAB[:window][:labeled]    +''
			VOCAB[:window][:indexed]    = @original_VOCAB[:window][:indexed]    +''
			VOCAB[:window][:as]         = @original_VOCAB[:window][:as]         +''
			VOCAB[:window][:opacity]    = @original_VOCAB[:window][:opacity]    +''
			VOCAB[:window][:back]       = @original_VOCAB[:window][:back]       +''
			VOCAB[:window][:contents]   = @original_VOCAB[:window][:contents]   +''
			VOCAB[:window][:open]       = @original_VOCAB[:window][:open]       +''
			VOCAB[:window][:openness]   = @original_VOCAB[:window][:openness]   +''
			VOCAB[:window][:close]      = @original_VOCAB[:window][:close]      +''
